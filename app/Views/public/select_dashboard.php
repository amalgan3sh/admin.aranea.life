                                    ...
                                    <div class="container">
                                            ...
                                            <div class="col-md-4 mb-4">
                                                <div class="card h-100">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text">Access the Barter System dashboard</p>
                                                        <a href="#" class="btn btn-info">Go to Barter</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row text-center">
                                            ...
                                            <div class="col-md-4 mb-4">
                                                <div class="card h-100">
                                                    <div class="card-body">
                                                        <i class="fas fa-water fa-3x mb-3 text-warning"></i>
                                                        <h5 class="card-title">Gods Line</h5>
                                                        <p class="card-text">Access the Gods Line dashboard</p>
                                                        <a href="#" class="btn btn-warning">Go to Gods Line</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Community Card -->
                                            <div class="col-md-4 mb-4">
                                                <div class="card h-100">
                                                    <div class="card-body">
                                                        ...
                                                        <h5 class="card-title">Aranea Community</h5>
                                                        <p class="card-text">Access the Community dashboard</p>
                                                        <a href="#" class="btn btn-danger">Go to Community</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Import Export Solutions Card -->
                                            <div class="col-md-4 mb-4">
                                                <div class="card h-100">
                                                    <div class="card-body">
